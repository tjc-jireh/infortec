    ...
    settings : {
      ...
      directives : {
        replace: function (el, path, trigger) {
          ...
          if (/imagenes/.test(el[0].nodeName)) {
    ...
    toggle_active_tab: function (tab, location_hash) {
      var S = this.S,
          ...
          interpret_keyup_action = function(e) {
            // Light modification of Heydon Pickering's Practical ARIA Examples: http://heydonworks.com/practical_aria_examples/recursos_matycperu/js/a11y.js
